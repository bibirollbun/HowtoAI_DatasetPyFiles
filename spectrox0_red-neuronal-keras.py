...
arquitectura1 = [200,1200,1200 , 1200, 1200, 1200] 
...
arquitectura2 = [200,1280, 1280, 1280, 1280, 1280]
...
arquitecturaFinal = arquitectura2
...
def func_model_reg():   
    ...
    x=Dropout(0.15)(x)
    x=Dense(1280, activation="relu", kernel_initializer='random_uniform', bias_initializer='zeros', kernel_regularizer=regularizers.l2(0.01))(x)
    x=Dropout(0.25)(x)
    x=Dense(1280, activation="relu", kernel_initializer='random_uniform', bias_initializer='zeros', kernel_regularizer=regularizers.l2(0.01))(x)
    x=Dropout(0.4)(x)
    x=Dense(1280, activation="relu", kernel_initializer='random_uniform', bias_initializer='zeros', kernel_regularizer=regularizers.l2(0.01))(x)
