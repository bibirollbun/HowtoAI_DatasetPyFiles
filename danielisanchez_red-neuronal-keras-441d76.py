...
arquitectura1 = [2048, 2048, 512, 512, 1024, 1024]
...
arquitectura2 = [4096, 4096, 4096, 2048, 2048, 2048]
...
arquitecturaFinal = [4096, 4096, 4096, 2048, 2048, 2048]
...
def func_model_reg():   
    inp = Input(shape=(200,))
    x=Dropout(0.1)(inp)
    x=Dense(2500, activation="relu", kernel_regularizer=regularizers.l2(0.01))(x)
    x=Dropout(0.3)(x)
    x=Dense(2000, activation="relu", kernel_regularizer=None)(x)
    x=Dropout(0.3)(x)
    x=Dense(2000, activation="relu", kernel_regularizer=None)(x)
    x=Dropout(0.3)(x)
    x=Dense(1000, activation="relu", kernel_regularizer=None)(x)
    x=Dropout(0.3)(x)
    x=Dense(1000, activation="relu", kernel_regularizer=None)(x)
    x=Dropout(0.3)(x)
    x=Dense(1000, activation="relu", kernel_regularizer=None)(x)
