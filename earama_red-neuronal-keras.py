...
arquitectura1 = [200,2100,2100,2100,2100,2100]
...
arquitectura2 = [200,2110,2110,2110,2110,2110]
...
arquitecturaFinal = [200,2100,2100,2100,2100,2100]
...
def func_model_reg():   
    inp = Input(shape=(200,))
    x=Dropout(0.1)(inp)
    x=Dense(200, activation="relu", kernel_initializer='random_uniform', bias_initializer='zeros', kernel_regularizer=regularizers.l2(0.01))(x)
    x=Dropout(0.15)(x)
    x=Dense(2100, activation="relu", kernel_initializer='random_uniform', bias_initializer='zeros', kernel_regularizer=regularizers.l2(0.01))(x)
    x=Dropout(0.25)(x)
    x=Dense(2100, activation="relu", kernel_initializer='random_uniform', bias_initializer='zeros', kernel_regularizer=regularizers.l2(0.01))(x)
    x=Dropout(0.4)(x)  
    x=Dense(2100, activation="relu", kernel_initializer='random_uniform', bias_initializer='zeros', kernel_regularizer=regularizers.l2(0.01))(x)
