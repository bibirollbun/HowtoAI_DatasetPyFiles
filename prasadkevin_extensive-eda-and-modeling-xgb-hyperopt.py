...
import scipy as sp #open source, BSD-licensed library for mathematics, science and engineering
from scipy import stats  #All of the statistics functions are located in the sub-package scipy.stats
import matplotlib.pyplot as plt  #Matplotlib is a plotting library for 2d .
import seaborn as sns #providing high level API for visualizing the data using Python(application programmin interface)
...
import os #The os module provides a big range of useful methods to manipulate files and directories. 
import gc ##gc(garbage colletor) exposes the underlying memory management mechanism
...
plt.subplots_adjust(hspace = 0.6, top = 0.80)
