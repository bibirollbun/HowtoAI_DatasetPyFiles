...
def func_model():   
    inp = Input(shape=(200,))
    x=Dense(1028, activation="relu", kernel_initializer='glorot_uniform', bias_initializer='zeros')(inp)
    x=Dense(1028, activation="relu", kernel_initializer='glorot_uniform', bias_initializer='zeros')(x) 
...
def func_model_reg():   
    inp = Input(shape=(200,))
    x=Dropout(0.1)(inp)
    x=Dense(1028, activation="relu", kernel_initializer='glorot_uniform', bias_initializer='zeros', kernel_regularizer=regularizers.l2(0.01))(x)
    x=Dropout(0.8)(x)
    x=Dense(1028, activation="relu", kernel_initializer='glorot_uniform', bias_initializer='zeros', kernel_regularizer=regularizers.l2(0.00))(x)
    x=Dropout(0.8)(x)
    x=Dense(1, activation="sigmoid", kernel_initializer='glorot_uniform', bias_initializer='zeros')(x) 
    model = Model(inputs=inp, outputs=x)
