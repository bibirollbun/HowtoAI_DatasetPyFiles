...
features = [c for c in test.columns if c != "TransactionDT"]
print(features)
...
feature_imp = pd.DataFrame(sorted(zip(clf.feature_importance(importance_type="gain"),features)), columns=['Value','Feature'])
